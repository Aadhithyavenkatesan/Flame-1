...
import 'package:flame_1/src/components/components.dart';
import 'package:flame_1/src/components/play_area.dart';
    ...
    world.add(Bat(
     ...
     world.addAll([
      for(var i = 0;i < brickColors.length; i++ )
        for(var j =1; j<=5; j++)
          Brick(
            position: Vector2((i+0.5) * brickWidth + (i + 1) * brickGutter, (j +2.0) * brickHeight + j * brickGutter,),
            color: brickColors[i],
          ),
